...
function help() {
  ...
  hero <slug> [...]    compile (and, when it ships, render) a page's hero through the wiki's Style Pack:
                       --title, one --beat and one --label per panel, --prop, --dry-run (wiki hero --help)
